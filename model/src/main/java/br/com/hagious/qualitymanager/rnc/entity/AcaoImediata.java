...
@NoArgsConstructor
@AllArgsConstructor
@JapeEntity(entity = "ThgRncAcaoImediata", table = "THGQMGACIM")
public class AcaoImediata {

    @Id
    @Column(name = "CODACIM")
    private BigDecimal codAcim;
    ...
    @Column(name = "ACAODETALHE")
    private String acaoDetalhe;
